...
const Listings = () => {
    ...
    return (
        <div id="mainContainer">
            {loading == true ? <p></p> : <h1 id="infoText">Search for your dream property to rent</h1>}
            {loading == true ? <p></p> :
                <form>
                    <div id="location">
            ...
            {loading == true ? <p>Loading properties...</p> :
                <div id="properties">
                    ...
                    {properties.length == 0 && propertyRequestSubmitted == true && loading == false ? <div id="noPropertiesFound"><h1>No results found</h1><p>Try widening
